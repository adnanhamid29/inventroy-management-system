...
#-=====variables=========
     ...
     #========title=========
        lbl_title=Label(self.root,text=" View Coustomer Bills",font=("goudy old style",30),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)
       ...
       #===================buttons============== 
        ...
        lbl_title=Label(bill_Frame,text="Coustomer Bill Area",bg="orange").pack(side=TOP,fill=X)
...
#=========================
    def show(self):
       ...
       # print(os.listdir('../IMS')) bill.txt,catagory.py
